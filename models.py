...
class AdminState(Enum):
    ...
    MANAGE_DIRECTORS = auto()
    AWAIT_DIRECTOR_REMOVAL_ID = auto()
    CHOOSE_ADD_DIRECTOR_RESTAURANT = auto()
    AWAIT_ADD_DIRECTOR_ID = auto()
...
class EmployeeRegistrationState(Enum):
    CHOOSE_RESTAURANT = auto()